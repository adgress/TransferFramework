    ...
    methods
        ...
        function [transformedTargetTrain,transformedTargetTest,metadata,...
            ...
            Y = [targetTrainData.Y;-1*ones(numel(targetTestData.Y),1)...
                ; Ys ];
            type = [DistanceMatrix.TYPE_TARGET_TRAIN*ones(numel(targetTrainData.Y),1);...
                DistanceMatrix.TYPE_TARGET_TEST*ones(numel(targetTestData.Y),1);
                DistanceMatrix.TYPE_SOURCE*ones(numel(sourceTrainData.Y),1)];
