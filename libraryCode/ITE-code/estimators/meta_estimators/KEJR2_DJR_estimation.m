function [K] = KEJR2_DJR_estimation(Y1,Y2,co)
%function [K] = KEJR2_DJR_estimation(Y1,Y2,co)
%Estimates the exponentiated Jensen-Renyi kernel-2 of two distributions from which we have samples (Y1 and Y2) using the relation: 
...
%   2)This is a meta method: the Jensen-Renyi divergence estimator can be arbitrary.
%
%INPUT:
