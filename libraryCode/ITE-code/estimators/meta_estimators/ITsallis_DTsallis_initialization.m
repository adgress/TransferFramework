function [co] = ITsallis_DTsallis_initialization(mult,post_init)
%function [co] = ITsallis_DTsallis_initialization(mult)
%function [co] = ITsallis_DTsallis_initialization(mult,post_init)
%Initialization of the "meta" Tsallis mutual information estimator based on Tsallis divergence.
...
%   3)This a meta method: the Tsallis divergence estimator can be arbitrary.
%
%INPUT:
