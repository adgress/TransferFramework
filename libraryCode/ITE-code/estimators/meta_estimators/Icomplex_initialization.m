function [co] = Icomplex_initialization(mult,post_init)
%function [co] = Icomplex_initialization(mult)
%function [co] = Icomplex_initialization(mult,post_init)
%Initialization of the complex "meta" mutual information estimator. The estimator is constructed from a real-valued (vector) mutual information estimator.
%
%Note:
%   1)The estimator is treated as a cost object (co).
%   2)We use the naming convention 'I<name>_estimation' to ease embedding new mutual information estimation methods.
%   3)This is a meta method: the real-valued (vector) mutual information estimator can be arbitrary.
%
%INPUT:
...
%other fields:    
    co.member_name = 'KCCA'; %you can change it to any mutual information estimator 
