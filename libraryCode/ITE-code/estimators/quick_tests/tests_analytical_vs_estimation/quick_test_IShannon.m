...
%initialization:
    ...
    I_hat_v = zeros(L,1); %vector of estimated Shannon mutual information
    
%distr, d -> samples (Y), analytical formula for the Shannon mutual information (I):
    switch distr
        case 'normal'
            ...
            %analytical value of Shannon mutual information (I):
                par.ds = ds;
                par.cov = C;
