function [I] = I3way_Lancaster_estimation(Y,ds,co)
%function [I] = I3way_Lancaster_estimation(Y,ds,co)
%Estimates mutual information (I) using the embedding of the 'Lancaster three-variable interaction measure'. 
%
...
%centering of K1,K2,K3, and their Hadamard product:
    H = eye(num_of_samples) - ones(num_of_samples) / num_of_samples;
    K1 = H * K1 * H;
    K2 = H * K2 * H;
    K3 = H * K3 * H;
    prod_of_Ks = K1 .* K2 .* K3;
    
I = mean(mean(prod_of_Ks)); %average of the elements   
