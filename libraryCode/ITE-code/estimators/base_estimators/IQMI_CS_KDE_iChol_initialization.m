function [co] = IQMI_CS_KDE_iChol_initialization(mult,post_init)
%function [co] = IQMI_CS_KDE_iChol_initialization(mult)
%function [co] = IQMI_CS_KDE_iChol_initialization(mult,post_init)
%Initialization of the Cauchy-Schwartz quadratic mutual information (QMI-CS) approximate estimator, applying Gaussian KDE (kernel density estimation) and incomplete Cholesky decomposition.
%
%Note:
