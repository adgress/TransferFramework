function [co] = IHSIC_initialization(mult,post_init)
%function [co] = IHSIC_initialization(mult)
%function [co] = IHSIC_initialization(mult,post_init)
%Initialization of the HSIC (Hilbert-Schmidt independence criterion) mutual information estimator.
%
%Note:
...
%other fields:    
    co.eta = 1e-6; %precision in the incomplete Cholesky decomposition
