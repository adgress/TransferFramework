function [co] = DsymBregman_kNN_k_initialization(mult,post_init)
%function [co] = DsymBregman_kNN_k_initialization(mult)
%function [co] = DsymBregman_kNN_k_initialization(mult,post_init)
%Initialization of the kNN (k-nearest neighbor, S={k}) based symmetric Bregman distance estimator.
%
%Note:
