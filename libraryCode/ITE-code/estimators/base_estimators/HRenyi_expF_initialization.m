function [co] = HRenyi_expF_initialization(mult,post_init)
%function [co] = HRenyi_expF_initialization(mult)
%function [co] = HRenyi_expF_initialization(mult,post_init)
%Initialization of the exponential family based Renyi entropy estimator (maximum likelihood + analytical formula in the chosen exponential family).
%
%Note:
