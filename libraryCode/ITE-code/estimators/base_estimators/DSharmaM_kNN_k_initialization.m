function [co] = DSharmaM_kNN_k_initialization(mult,post_init)
%function [co] = DSharmaM_kNN_k_initialization(mult)
%function [co] = DSharmaM_kNN_k_initialization(mult,post_init)
%Initialization of the exponential family based Sharma-Mittal divergence estimator (maximum likelihood + analytical formula in the chosen exponential family).
%
%Note:
