function [co] = IKCCA_initialization(mult,post_init)
%function [co] = IKCCA_initialization(mult)
%function [co] = IKCCA_initialization(mult,post_init)
%Initialization of the KCCA (kernel canonical correlation analysis) mutual information estimator.
%
%Note:
