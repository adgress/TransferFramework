function [co] = I3way_Lancaster_initialization(mult,post_init)
%function [co] = I3way_Lancaster_initialization(mult)
%function [co] = I3way_Lancaster_initialization(mult,post_init)
%Initialization of the 'Lancaster three-variable interaction measure' embedding based mutual information estimator.
%
%Note:
