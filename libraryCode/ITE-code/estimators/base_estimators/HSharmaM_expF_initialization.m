...
%function [co] = HSharmaM_expF_initialization(mult,post_init)
%Initialization of the exponential family based Sharma-Mittal entropy estimator (maximum likelihood + analytical formula associated to the chosen exponential family).
%
%Note:
...
%other fields:
    ...
    %  2)Tsallis entropy (H_{T,alpha}): H_{SM,alpha,beta} = H_{T,alpha}, if alpha = beta.
