function [H] = HRenyi_expF_estimation(Y,co)
%function [H] = HRenyi_expF_estimation(Y,co)
%Estimates the Renyi entropy (H) of Y using maximum likelihood estimation (MLE) + analytical formula in the chosen exponential family.
%Assumptions: 
...
%
%REFERENCE: 
%    Frank Nielsen and Richard Nock. A closed-form expression for the Sharma-Mittal entropy of exponential families. Journal of Physics A: Mathematical and Theoretical, 45:032003, 2012. (analytical formulas)
...
H = (F1 - F2) / (1 - co.alpha); %assumption: k, the carrier measure is zero
