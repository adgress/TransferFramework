function [co] = DKL_PSD_SzegoT_initialization(mult,post_init)
%function [co] = DKL_PSD_SzegoT_initialization(mult)
%function [co] = DKL_PSD_SzegoT_initialization(mult,post_init)
%Initialization of the power spectral density representation and Szego's theorem based Kullback-Leibler divergence estimator.
%
%Note:
