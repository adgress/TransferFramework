function [co] = KBhattacharyya_kNN_k_initialization(mult,post_init)
%function [co] = KBhattacharyya_kNN_k_initialization(mult)
%function [co] = KBhattacharyya_kNN_k_initialization(mult,post_init)
%Initialization of the Bhattacharyya kernel estimator. The estimation is based on k-nearest neighbors (S={k}).
%
%Note:
...
%other fields:
	...
	%Possibilities for rewriting the Bhattacharyya kernel:
