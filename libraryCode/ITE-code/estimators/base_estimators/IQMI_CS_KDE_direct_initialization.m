function [co] = IQMI_CS_KDE_direct_initialization(mult,post_init)
%function [co] = IQMI_CS_KDE_direct_initialization(mult)
%function [co] = IQMI_CS_KDE_direct_initialization(mult,post_init)
%Initialization of the Cauchy-Schwartz quadratic mutual information (QMI-CS) direct estimator based on Gaussian KDE (kernel density estimation).
%
%Note:
