function [e,de] = sample_subspaces_ABC(num_of_comps,num_of_samples)
%function [e,de] = sample_subspaces_ABC(num_of_comps,num_of_samples)
%Sampling from the 'ABC' dataset; number of subspaces: num_of_comps; number of samples: num_of_samples.
%
%OUTPUT:
