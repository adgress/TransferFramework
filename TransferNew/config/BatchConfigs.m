classdef BatchConfigs < Configs
    ...
    methods
        function [obj] = BatchConfigs()
            ...
            obj.configsStruct.mainConfigs=TransferNewMainConfigs();
    ...
    methods(Static)
        function [configs] = makeTommasiOverrideConfigs()
            ...
            if false && ProjectConfigs.experimentSetting == ...
                ...
                for idx=1:length(targetLabels)
                    ...
                    configs{idx} = c;
                    if false && ProjectConfigs.experimentSetting == ProjectConfigs.NOISY_EXPERIMENT
                        break;
                    end
                end
            end
        ...
        function [configs] = makeNGOverrideConfigs()
            ...
            if true
                ...
                sourceDataSetToUse = {'CR1', 'CR2','CR3','CR4','ST1','ST2','ST3','ST4'};
